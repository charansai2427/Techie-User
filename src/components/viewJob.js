      ...
      <div className="">
        <div className="hiring-div container">
          ...
          <div
            ...
            className=" container sharejob" onClick={handleClick} toggle={toggle} shareUrl="http://localhost:3000/home"
          > Share Job
          </div>
          ...
          <div style={{ width: '100%' }}>
            <Modal isOpen={open} toggle={() => setOpen(false)}>
              ...
              <ModalBody>
                ...
                <hr />
                <div className="url">
                  <label style={{color:'gray'}}>Share Url :</label>
                
                  <span style={{color:'skyblue'}}>https://localhost:3000/home</span>

               <div onClick={handleCopy} style={{float:'right',paddingTop:'-4em'}}>
               <MdContentCopy >
        ...
        <div className=" viewjobsDetails-main  shadow border rounded container w-90% ">
          <div className=" viewjobsDetails container">
            <div className="viewjobsDetails-1">
              ...
              <div>
                <label><b>STATES/CITIES</b></label>
                <p>{getJobDetails && getJobDetails.States}</p>
              </div>
              <div>
                <label><b>OPENINGS</b></label>
      ...
      <div className="container">
        <div className="  card-company shadow border rounded">
          ...
          <div className="locationcomp container">
            ...
            <div >
              {
                <div style={{ color: 'gray' }}><b>{getJobDetails && getJobDetails.States}</b></div>
              }
