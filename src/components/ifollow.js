  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="followcomp ">
          {
            followedCompanies && followedCompanies.map((e) => {
              return (
                <div className="card shadow border rounded p-3" >
                  <div className="card-pic card-profile pt-3 p-2">
                    <p style={{ backgroundColor: '#' + Math.floor(Math.random() * 16777215).toString(16)}}>{e.value.company_name.slice(0, 2).toUpperCase()}</p>
                  </div>
        ...
        <div  className="followcomp">
          {
            companyData && companyData.map((e) => {
              return (
                <div className="card shadow border rounded p-3" >
                  <div className=" card-pic card-profile pt-3 p-2">
                    <p style={{ backgroundColor: "#" + Math.floor(Math.random() * 16777215).toString(16)}}>{e?.company_name.slice(0, 2).toUpperCase()}</p>
                  </div>
