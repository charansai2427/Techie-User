 ...
 const filter = () => {
  ...
  return (
    <div className="homePage-container bg-white" style={{ backgroundColor:'rgb(243,243,243)'}}>
      <Header />
      <div className=" container d-flex justify-content-end" onClick={filter} >
        <div className="d-flex ">
          <div>Sort by :</div>
          <div >
            <select 
              onChange={(e) =>{
                //  dispatch(filterJobs({ filterInp: e.target.value }))
      ...
      {open ? (
        ...
        <div className="map">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3800.0386556256476!2d83.23167277586289!3d17.74281769246731!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3967274842f4df%3A0x9711e68b73419d51!2sTechiepanda!5e0!3m2!1sen!2sin!4v1696832682466!5m2!1sen!2sin"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" style={{height:'11em',width:'12em',marginTop:'-0.5em'}}/>
        </div>
